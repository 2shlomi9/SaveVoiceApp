...
public class RecordAdapter extends RecyclerView.Adapter<adapters.RecordAdapter.MyViewHolder> {
...
//    private StorageReference storageReference;
    ...
    private List<String> receive_records;
    ...
    public RecordAdapter(Context context, ArrayList<Group> list, AlertDialog.Builder groupOptions) {
        ...
        this.receive_records = new ArrayList<String>();
    ...
    @NonNull
    @Override
    public adapters.RecordAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.group_view, parent, false);
        return new adapters.RecordAdapter.MyViewHolder(v);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull adapters.RecordAdapter.MyViewHolder holder, int position) {
